...
const Toggle = Frontend UI.forwardRef<
  Frontend UI.ElementRef<typeof TogglePrimitive.Root>,
  Frontend UI.ComponentPropsWithoutRef<typeof TogglePrimitive.Root> & VariantProps<typeof toggleVariants>
